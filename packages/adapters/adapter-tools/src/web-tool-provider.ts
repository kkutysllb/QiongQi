import type { QiongqiCapabilitiesConfig, WebCapabilityConfig } from '@qiongqi/contracts'
import type { WebFetchResult, WebProvider, WebSearchResult } from '@qiongqi/ports'
import { sourceIdFor, UnavailableWebProvider } from '@qiongqi/ports'
...
export function buildWebToolProviders(
  config: QiongqiCapabilitiesConfig['web'] | undefined,
